...
import { ChevronLeft, Loader2, MapPin, Search, SlidersHorizontal } from "lucide-react";
...
export default function Properties() {
  ...
  }, [areaQuery, priceRange, propertiesQuery.data, propertiesQuery.isLoading]);
          ...
          <div className="flex flex-col gap-8 border-b border-slate-100 px-6 py-8 md:px-10 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <h1 className="mt-2 text-3xl font-black md:text-5xl">כל הנכסים במקום אחד</h1>
              </div>
            </div>
          ...
          <div className="px-6 py-8 md:px-10">
            <div className="grid gap-8 xl:grid-cols-[320px_1fr]">
              <aside className="order-1 rounded-[30px] border border-slate-200 bg-[#fbfdff] p-6 shadow-[0_18px_40px_rgba(15,23,42,0.05)] xl:order-none">
                ...
                <div className="mt-6 rounded-[24px] bg-[#d9ae4c] p-5 text-white">
                  <p className="text-sm font-black uppercase tracking-[0.06em] text-white/80">תוצאה נוכחית</p>
                  <p className="mt-3 text-4xl font-black">{filteredProperties.length}</p>
                  <p className="mt-2 text-sm leading-7 text-white/90">נכסים תואמים לטווח המחיר ולאזור שבחרתם.</p>
                </div>
              </aside>
                    ...
                    >
                      ...
                      <div className="p-5">
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <span className="rounded-full bg-[#fff8d7] px-3 py-1 text-xs font-black text-[#b8860b]">{property.status}</span>
                        </div>
                        ...
                        <div className="mt-4 grid grid-cols-2 gap-3 text-sm font-bold text-slate-700">
                          <div className="rounded-2xl bg-[#fff8e6] px-3 py-3">{property.rooms} חדרים</div>
                          <div className="rounded-2xl bg-[#fff8e6] px-3 py-3">{property.sqm} מ״ר</div>
                        </div>
